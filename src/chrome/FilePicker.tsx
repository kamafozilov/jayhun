  ...
  return createPortal(
    <div className="fixed inset-0" style={{ zIndex: LAYER.dialog }}>
      ...
      <div
        ...
        className="absolute left-1/2 top-[12%] flex w-[min(560px,calc(100vw-24px))] -translate-x-1/2 flex-col overflow-hidden rounded-lg border border-content/10 floating-surface"
      >
